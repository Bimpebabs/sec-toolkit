...
This repository is a curated list of links. The only realistic "vulnerability" is a link that points to a malicious or compromised destination, or a link that has been taken over by a bad actor after the original project was abandoned.

If you notice a link in this list that now points to:

- A domain that has been squatted or taken over
...
## What is not a security issue for this repo

- Vulnerabilities in the tools listed (report those to the tool's own maintainers)
- Disagreements about whether a tool belongs on the list (open a normal issue)
- Outdated descriptions (open a normal issue or PR)
